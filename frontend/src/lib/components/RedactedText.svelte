...
{#each segments as segment, i}{segment}{#if i < segments.length - 1}<span
      class="inline-flex items-center gap-1 rounded border border-amber-300 bg-amber-100 px-1.5 align-middle font-sans text-[0.65rem] font-medium tracking-wide text-amber-700 uppercase select-none"
