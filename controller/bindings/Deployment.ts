...
export type Deployment = { id: DeploymentId, digest: string, status: DeploymentStatus, service_id: string, created_at: string, service_name: ServiceName, project_name: ProjectName, hostname: HostName, 
/**
