...
export type ContainerStateResponse = { hostname: HostName, project_name: ProjectName, service_name: ServiceName, 
/**
 ...
 */
container_inspections: any, last_logs: string | null, last_updated: string, };
